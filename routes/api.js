...
router.get('/downloader/ytmp3', async(req, res, next) => {
  ...
  if(listkey.includes(apikey)){
    fetch(encodeURI(`https://danzzapi.xyz/api/downloader/ytmp3?url=${query}&apikey=danzz`))
    .then(response => response.json())
        .then(hasil => {
...
router.get('/downloader/ytmp4', async(req, res, next) => {
  ...
  if(listkey.includes(apikey)){
    fetch(encodeURI(`https://danzzapi.xyz/api/downloader/ytmp4?url=${query}&apikey=danzz`))
    .then(response => response.json())
        .then(hasil => {
...
router.get('/search/youtube', async(req, res, next) => {
  ...
  if(listkey.includes(apikey)){
    fetch(encodeURI(`https://danzzapi.xyz/api/search/youtube?query=${query}&apikey=danzz`))
    .then(response => response.json())
        .then(hasil => {
...
var requestSettings = {
url: `https://danzzapi.xyz/api/other/qrcode?url=${text}&apikey=danzz`, method: 'GET', encoding: null };
request(requestSettings, function(error, response, body) {
res.set('Content-Type', 'image/png');
res.send(body)
})
